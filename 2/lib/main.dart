    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: TextTheme(
          ...
          subtitle1: TextStyle(fontSize: 14, fontWeight: FontWeight.normal, color: Colors.yellow),
          subtitle2: TextStyle(fontSize: 14, fontWeight: FontWeight.normal, color: Colors.deepOrange),
        )
      ),
    );
  }
